changelog = {
	"1.4.2.0": [
		"1.Reorder the card position,the player's card placed in the same way.",
		"2.Modify the player select dlg,it has color.the blue color is always the player self,and the red color is the other player."
	],
	"1.4.3.0": [
...
changelogcn = {
	"1.4.2.0": [
		"1.修改卡品牌位置,桌面上每位玩家的卡牌在对齐到一边(玩家A左对齐,玩家B右对齐.)",
		"2.现在玩家选择窗口带有颜色,玩家自己的颜色为红色,对面玩家的颜色为蓝色"
	],
	"1.4.3.0": [
		"Cards you don't own are moved to it's owners Discard Pile or Out of Game on the individual functions. Move to Hand or Draw Deck print a message if you don't own the card. With this change you no longer need to pass control of a card you don't own and ask your opponent to destroy it."
	],
