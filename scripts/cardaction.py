...
aftercalculate = dict( # A dictionary which holds all cards action
             ...
             SuperiorClaim = ("Superior Claim","8e9b06da-991e-4608-a16b-caf96209641a","3","both","增加权力",1,"hand","5"),
             TearsofLys = ("Tears of Lys","b29c7bb5-7b84-4e94-a30b-8332fad51c2a","2","attacker","增加标记、杀死角色",1,"hand",""),
             AshaGreyjoy = ("Asha Greyjoy","41367a9d-b751-4632-9973-97d2e4df7087","all","attacker","重置角色",1,"table",""),
             EuronCrowsEye = ("Euron Crow's Eye","912e5447-89b3-4896-903c-6f5ed78113e1","all","both","放置进场",1,"table",""),
             TheonGreyjoy = ("Theon Greyjoy","9a29f7bb-baa9-4475-8e35-55b845618822","all","attacker","增加权力",1,"table",""),
             ThrowingAxe = ("Throwing Axe","c3eeb001-e6a1-48ae-b310-cbd0d2c84653","all","attacker","杀死角色",1,"table",""),
             WeDoNotSow = ("We Do Not Sow","62570a84-3203-468d-9529-37dbbc6d191c","all","attacker","弃除地区、弃除附属",1,"hand",""),
             Lannisport = ("Lannisport","5702d5f9-ae1e-435b-ae86-01c14817431a","2","both","补充手牌",1,"table",""),
             MaesterCaleotte = ("Maester Caleotte","4f58fa4d-7172-4466-86eb-32b2bb91b516","all","both","减少符号",1,"table",""),
             TheRedViper = ("The Red Viper","73a43b0f-8337-4e71-96b7-9553d5d57ddf","all","attacker","增加权力",1,"table","5"),
             GhastonGrey = ("Ghaston Grey","982acc7e-86c0-4bdd-84da-3b05e53dffa1","all","defender","返回手牌",1,"table",""),
             Sunspear = ("Sunspear","f2772a6e-2ed4-4fb9-8699-5497aee496e3","all","defender","增加效能",1,"table",""),
             DoransGame = ("Doran's Game","427a5213-1be5-4b36-94be-04a5b3486575","2","both","增加权力",1,"hand","5"),
             ...
             LikeWarmRain = ("Like Warm Rain","ef7d8bdf-1c56-4895-be9a-7a3ed059dcd3","2","defender","杀死角色",1,"hand",""),
             Rhaegal = ("Rhaegal","ac263d0d-d7db-49e7-bdc4-2e131d95aad4","all","both","重置角色",1,"table",""),
             PlazaofPunishment = ("Plaza of Punishment","06803230-d3a4-46f7-935a-1a7314839b9e","3","both","减少能力值、杀死角色",1,"table",""),
             ...
             TheMander = ("The Mander","bf44916f-cc99-4f0a-87f0-b529a426df7b","all","both","补充手牌",1,"table","5"),
